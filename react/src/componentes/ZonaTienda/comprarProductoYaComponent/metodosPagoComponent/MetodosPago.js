...
function MetodosPago({setPedido,pedido}) {
const [showModal,setShowModal]=useState(false); //Para mostrar formulario de tarjeta de credito
const [paymentMethod, setPaymentMethod]=useState(''); //Para saber que metodo de pago has escodigo
const [cardDetails, setCardDetails]=useState({
                                                      ...
                                                      nombre:'',
                                                      apellidos:''
                                                    }); //Para tener la informacion de la tarjeta 

const handlePaymentChange = (e) =>{ //Controlas el metodo de pago y si mostrar o no el show modal
...
const handleCardDetailChange = (event) => { //Para almacenar la inforamcion del formulario de la tarjeta de credito 
...
const handleModalClose = () => { //Para cerrar el modal
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="row">
                <div className="col"><a href='/Tienda/Direccion'>Modificar la direccion de facturacion</a></div>
              </div>
