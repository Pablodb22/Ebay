...
routerTienda.get('/EncontrarPujaProducto', tiendaEndPointsController.EncontrarPujaProducto);
routerTienda.post('/OpcionPujar', tiendaEndPointsController.OpcionPujar);
