...
import Puja from './componentes/zonaTienda/pujaComponente/puja';

import restTienda from './servicios/restTienda';
import Seguridad from './componentes/zonaCliente/zonaPanelClente/zonaCuenta/zonaDatosPersonales/zonaSeguridad/SeguridadComponent/Seguridad';
import CambiarContrasena from './componentes/zonaCliente/zonaPanelClente/zonaCuenta/zonaDatosPersonales/zonaSeguridad/CambiarContrasenaComponent/cambiarContrasena';
...
const _routerObject=createBrowserRouter(
  [
      ...
      children:[
        ...
        { path:'/Cliente/Panel/MieBay/:idPanel?', element: <MiEbay></MiEbay> },
        {
          ...
          children:[
                    ...
                    { path:'Seguridad', element: <Seguridad></Seguridad>,children:[{path:'CambiarContrasena',element:<CambiarContrasena></CambiarContrasena>}]},
    ...
    {path:'/Tienda/Puja',element:<Puja></Puja>},
